...
object Constants {
    ...
    const val FIRST_PAGE_DESCRIPTION = "Share your letter with the world (only if you wish) and read the amazing letter that others sent to their future selves."

    const val SECOND_PAGE_TITLE = "Send it to the future"
    const val SECOND_PAGE_DESCRIPTION = "On your chosen date, we'll deliver your letter from the past for you to read and reflect. You can also add your friends and family as additional recipients."

    const val THIRD_PAGE_TITLE = "Write a letter"
    const val THIRD_PAGE_DESCRIPTION= "Write a letter to 'Future Me' and choose a date for it to be delivered, such as a birthday, graduation or the other special occasion."
}